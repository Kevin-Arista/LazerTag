...
function Contact(props){
    return(
        <div className="Contact">
            ...
            <MemberCard name="Ezzy Aldaylam" description="designed and developed the blaster's design into production" major="Intended Major: Mechanical Engineering" png={Ezzadin}/>
            </div>
            ...
            <div className='team-section'>
            <MemberCard name="Evelio Velez" description="designed, tested, and developed software for the blasters" major="Intended Major: Computer Science" png={Evelio}/>
            <MemberCard name="Kevin Arista" description="UX/UI, developed application for LazzarX using MERNstack" major="Intended Major: Computer Science" png={Kevin}/>
            </div>
        </div>
    );
}
